...
- Programming Language：语言特性、性能与可维护性
- AI：LLM 应用、模型工程与工具链
- Robotics：控制、感知与软件架构

如果你也关注这些方向，欢迎一起交流与构建。

## Open-source acknowledgements / 开源致谢

This blog is built with and benefits from the following open-source projects:

- [Hugo](https://gohugo.io/) — static site generator, licensed under Apache License 2.0.
...
衷心感谢所有开源项目的维护者与贡献者。正是这些持续、开放的工作，让这个博客得以建立，也让知识能够更自由地传播。
